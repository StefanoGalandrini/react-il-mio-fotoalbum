		...
		<div
			...
			{user ? (
				<div className="card-buttons flex justify-center gap-6 mt-6">
					<button
						onClick={handleEdit}
						className="px-3 py-1 rounded-md bg-lime-900 text-stone-300 transition-all duration-150 hover:bg-lime-700 hover:text-white">
						<i className="fa-solid fa-pen-to-square"></i> Modifica
					</button>
					<button
						onClick={handleDelete}
						className="px-3 py-1 rounded-md bg-red-800 text-stone-300 transition-all duration-150 hover:bg-red-600 hover:text-white">
